      ...
      <div class="sidebar col-md-2" style="width:100%; height:100%; text-align:center">
        <div class="d-flex flex-column flex-shrink-0 p-3 text-white " style="width: 280px;   ">
          ...
          <ul class="nav nav-pills flex-column mb-auto">
            ...
            <li class="nav-item">
              <a href="#" class="nav-link text-white" id="VISUAL" v-on:click="category( $event)" >
            ...
            <li>
              <a href="#" class="nav-link text-white" id="INDUSTRIAL" v-on:click="category( $event)">
            ...
            <li>
              <a href="#" class="nav-link text-white " id="ARCHITECT" v-on:click="category( $event)">
            ...
            <li>
              <a href="#" class="nav-link text-white" id="FASHION" v-on:click="category( $event)">
            ...
            <li>
              <a href="#" class="nav-link text-white" id="CRAFT" v-on:click="category( $event)">
            ...
            <li>
              <a href="#" class="nav-link text-white" id="VIDEO" v-on:click="category($event)">
            ...
            <li>
              <a href="#" class="nav-link text-white" id="GAME" v-on:click="category($event)">
      ...
      this.$router.push({
       ...
       //router를 쓸때 router폴더에 있는 index.js 확인 (부모->자식 컴포넌트 이동시 props를 true 해야 넘어감)
        ...
        query: {
          ...
          artexhibitionIdx: data.exhibitionIdx
        }
      }) 
    },
...
// 페이징 함수 구현  
    ...
    getItem() {
      ...
      axios.get("http://ec2-13-124-134-65.ap-northeast-2.compute.amazonaws.com:8080/api/exhibitionlist?size=15&page=" +page)
